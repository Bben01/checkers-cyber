...
from deep_learning_algorithms.non_adaptive.util.alphazero_util import action_spaces_new
...
class AlphaZeroAgent:
    ...
    def choose_action(self, state):
        ...
        possible_action = State.getPossibleActions(self.stacked_state.head)
        from deep_learning_algorithms.non_adaptive.util import AIElements
