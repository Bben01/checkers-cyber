...
from deep_learning_algorithms.non_adaptive.config import StackedStateConfig
...
class StackedState:
    ...
    def get_deep_representation_stack(self):
        ...
        """
        input_network = np.zeros((Plateau.taillePlateau, Plateau.taillePlateau, self.planes_total))
        ...
        for state in reversed(self.deque_collection):
            ...
            counter_iter += 1
            possible_action = state.getPossibleActions(state)
    ...
    def mirror_stacked_state(self):
        ...
        :return:
        """
        from deep_learning_algorithms.non_adaptive.util.state_modifier_util import mirror_state
