...
class PawnNetZero:
    ...
    def __init__(self, action_size, board_x=8, board_y=8, num_channels_feature=1):
        self.board_x, self.board_y = board_x, board_y
        self.action_size = action_size
