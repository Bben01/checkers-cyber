...
class MoveInfos:
    ...
    def __init__(self, error_msg: str, has_to_eat_again: bool, ended_turn: bool, last_deplacement: Deplacement, piece_killed: Piece, pos_killed: tuple = None):  # NOQA
        ...
        self.lastMove = last_deplacement

    @staticmethod
    def create_didnt_move():
        return MoveInfos("The piece didn't move!", False, False, None, None)

    @staticmethod
    def create_invalid_move(string: str):
        return MoveInfos(f"The move is invalid because { string }", False, False, None, None)

    @staticmethod
    def create_kill_move(pos_killed: tuple, has_to_eat_again: bool, last_deplacement: Deplacement, piece_killed: Piece):
        return MoveInfos("", has_to_eat_again, not has_to_eat_again, last_deplacement, piece_killed, pos_killed)

    @staticmethod
    def create_normal_move(last_deplacement: Deplacement):
        return MoveInfos("", False, True, last_deplacement, None)
